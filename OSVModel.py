...
class ModelOSV(PhysicalProperty):
    ...
    def calGriffith(self, q, g, cpf, lam): # Griffith et al. (1958) 1/10배
            ...
            for k in range(1, 10000):  # step 2 - 7 반복
                ...
                for j in range(3):
                    ...
                    df.loc[i, 'mu_ave'] = PropsSI('V', 'T', df.loc[i, 'T_ave'], 'P', df.loc[i, 'P_ave'] * 1e5,
                                                      df.loc[i, 'refri'])
                    df.loc[i, 're_ave'] = Property_OSV.re(self,df.loc[i, 'g'], df.loc[i, 'dh'], df.loc[i, 'mu_ave'])
                ...
                df.loc[i, 'hi'] = PropsSI('H', 'T', df.loc[i, 'Ti'], 'P', df.loc[i, 'Pi_new'] * 1e5,
                                              df.loc[i, 'refri'])
                df.loc[i, 'q_guess'] = Property_OSV.q_guess(self,df.loc[i, 'doi'], df.loc[i, 'dio'], df.loc[i, 'lh'],
                                                     df.loc[i, 'g'],
    ...
    def calOfiJeong(self, df):
        ...
        for i in df.index:
            ...
            for k in range(1, 10000):  # step 2 - 7 반복
                ...
                df.loc[i, 'hi'] = PropsSI('H', 'T', df.loc[i, 'Ti'], 'P', df.loc[i, 'Pi_new'] * 1e5,
                                              df.loc[i, 'refri'])
                df.loc[i, 'q_guess'] = Property_OSV.q_guess(self,df.loc[i, 'doi'], df.loc[i, 'dio'], df.loc[i, 'lh'], df.loc[i, 'g'],
                                                df.loc[i, 'geo'], df.loc[i, 'hsur'], df.loc[i, 'dh'],
                                                df.loc[i, 'ho'], df.loc[i, 'hi'],
                                                df.loc[i, 'de'])
