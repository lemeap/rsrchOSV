...
if __name__ == "__main__":
    ...
    for i, row in osvTb.iterrows():
        if osvTb.loc[i, "refri"] is "Water":
            ...
            osvTb.loc[i, "tsat"] = round(
                PropsSI("T", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 4
            )
            osvTb.loc[i, "kf"] = round(
                PropsSI("L", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 6
            )
            osvTb.loc[i, "kv"] = round(
                PropsSI("L", "P", osvTb.loc[i, "p"] * 1e5, "Q", 1, "Water"), 6
            )
            osvTb.loc[i, "muf"] = round(
                PropsSI("V", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 12
            )
            osvTb.loc[i, "muv"] = round(
                PropsSI("V", "P", osvTb.loc[i, "p"] * 1e5, "Q", 1, "Water"), 12
            )
            osvTb.loc[i, "rhof"] = round(
                PropsSI("D", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 6
            )
            osvTb.loc[i, "rhov"] = round(
                PropsSI("D", "P", osvTb.loc[i, "p"] * 1e5, "Q", 1, "Water"), 6
            )
            osvTb.loc[i, "cpf"] = round(
                PropsSI("C", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 6
            )
            osvTb.loc[i, "cpv"] = round(
                PropsSI("C", "P", osvTb.loc[i, "p"] * 1e5, "Q", 1, "Water"), 6
            )
            osvTb.loc[i, "sigma"] = round(
                PropsSI("I", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 6
            )
            osvTb.loc[i, "hgo"] = round(
                PropsSI("H", "P", osvTb.loc[i, "p"] * 1e5, "Q", 1, "Water"), 6
            )
            osvTb.loc[i, "hfo"] = round(
                PropsSI("H", "P", osvTb.loc[i, "p"] * 1e5, "Q", 0, "Water"), 6
            )
            ...
            osvTb.loc[i, "bo"] = round(
                pro.calBo(osvTb.loc[i, "q"], osvTb.loc[i, "lam"], osvTb.loc[i, "g"]), 6
            )
    ...
    for i, row in osvTb.iterrows():
        ...
        try:
            if osvTb.loc[i, "alpha"] is np.nan:  # void fraction 데이터가 아니라 OSV 실험 데이터에서 xosv 계산
                print(
                    "{} 번째 {} source의 run_id {}는 OSV를 바로 계산합니다.".format(
                        i, osvTb.loc[i, "source"], osvTb.loc[i, "run_id"]
                    )
                )
                osvTb.loc[i, "xosv"] = round(
                    -osvTb.loc[i, "cpf"] * osvTb.loc[i, "tosv"] / osvTb.loc[i, "lam"], 6
                )
                ...
                print(
                    "{}의 {} 실험 데이터의 r2: {}".format(
                        osvTb.loc[i, "source"], osvTb.loc[i, "run_id"], r2
                    )
                )
                ...
                if r2 < 0.9:
                    ...
                    osvTb.loc[i, "staubXeq"] = round(
                        (
                            2 * linReg.coef_[0, 3] * inflectionPoint ** 3
                            + linReg.coef_[0, 2] * inflectionPoint ** 2
                            - linReg.intercept_[0]
                        )
                        / (
                            3 * linReg.coef_[0, 3] * inflectionPoint ** 2
                            + 2 * linReg.coef_[0, 2] * inflectionPoint
                            + linReg.coef_[0, 1]
                        ),
                        4,
                    )
                ...
                osvTb.loc[i, "pr"] = round(
                    pro.calPr(osvTb.loc[i, "cpf"], osvTb.loc[i, "muf"], osvTb.loc[i, "kf"]), 6
                )
                ...
                if osvTb.loc[i, "pr"] <= 1.5:
                    if osvTb.loc[i, "xMartin"] < 0.45:
                        if osvTb.loc[i, "martinXeq"] > 0:
                            osvTb.loc[i, "xosv"] = round(
                                min(osvTb.loc[i, ["serizawaXeq", "staubXeq"]]), 4
                            )
                        else:
                            osvTb.loc[i, "xosv"] = round(osvTb.loc[i, "martinXeq"], 4)
                    else:
                        osvTb.loc[i, "xosv"] = round(
                            min(osvTb.loc[i, ["martinXeq", "staubXeq"]]), 4
                        )
                else:
                ...
                # OSV subcooling 계산
                osvTb.loc[i, "tosv"] = round(
                    -osvTb.loc[i, "xosv"] * osvTb.loc[i, "lam"] / osvTb.loc[i, "cpf"], 6
                )
            ...
            osvTb.loc[i, "pe"] = round(
                pro.calPe(
                    osvTb.loc[i, "dh"], osvTb.loc[i, "g"], osvTb.loc[i, "cpf"], osvTb.loc[i, "kf"]
                ),
                6,
            )
            ...
            osvTb.loc[i, "re"] = round(
                pro.calRe(osvTb.loc[i, "g"], osvTb.loc[i, "dh"], osvTb.loc[i, "muf"]), 6
            )
            ...
            osvTb.loc[i, "nu"] = round(
                pro.calNu(
                    osvTb.loc[i, "q"], osvTb.loc[i, "dh"], osvTb.loc[i, "kf"], osvTb.loc[i, "tosv"]
                ),
                6,
            )
            osvTb.loc[i, "ec"] = round(
                pro.calEc(osvTb.loc[i, "v"], osvTb.loc[i, "cpf"], osvTb.loc[i, "tosv"]), 6
            )
        except Exception as e:
            print(
                "{} source의 run_id: {}에서 Error 발생. 낮은 Polyfit 예측정확도를 가집니다.".format(
                    osvTb.loc[i, "source"], osvTb.loc[i, "run_id"]
                )
            )
            print(e)
    ...
    corOSVTb = pd.DataFrame(
        data=osvTb[["source", "run_id", "xosv", "tosv", "xeq1", "geo"]]
    )  # comparison table
    ...
    for i, row in corOSVTb.iterrows():  # Apply models or correlations to dataframe
        try:
            # OSV
            corOSVTb.loc[i, "dt_js"], corOSVTb.loc[i, "x_js"] = mod.calJeong(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "rhov"],
                osvTb.loc[i, "dh"],
            ...
            corOSVTb.loc[i, "dt_sz"], corOSVTb.loc[i, "x_sz"] = mod.calSahaZuber(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "g"],
            ...
            corOSVTb.loc[i, "dt_levy"], corOSVTb.loc[i, "x_levy"] = mod.calLevy(
                osvTb.loc[i, "sigma"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "muf"],
            ...
            corOSVTb.loc[i, "dt_bowr"], corOSVTb.loc[i, "x_bowr"] = mod.calBowring(
                osvTb.loc[i, "p"],
                osvTb.loc[i, "q"],
                osvTb.loc[i, "v"],
                osvTb.loc[i, "lam"],
            ...
            corOSVTb.loc[i, "dt_unal"], corOSVTb.loc[i, "x_unal"] = mod.calUnal(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "pr"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "v"],
            ...
            corOSVTb.loc[i, "dt_msz"], corOSVTb.loc[i, "x_msz"] = mod.calMSZ(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "g"],
            ...
            corOSVTb.loc[i, "dt_costa"], corOSVTb.loc[i, "x_costa"] = mod.calCosta(
                osvTb.loc[i, "geo"],
                osvTb.loc[i, "q"],
                osvTb.loc[i, "v"],
                osvTb.loc[i, "cpf"],
            ...
            corOSVTb.loc[i, "dt_griffith"], corOSVTb.loc[i, "x_griffith"] = mod.calGriffith(
                osvTb.loc[i, "q"], osvTb.loc[i, "g"], osvTb.loc[i, "cpf"], osvTb.loc[i, "lam"]
            )  # Griffith
            corOSVTb.loc[i, "dt_hancox"], corOSVTb.loc[i, "x_hancox"] = mod.calHancox(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "cpf"],
                osvTb.loc[i, "lam"],
                osvTb.loc[i, "kf"],
            ...
            corOSVTb.loc[i, "dt_ha2005"], corOSVTb.loc[i, "x_ha2005"] = mod.calHa2005(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "kf"],
                osvTb.loc[i, "cpf"],
            ...
            corOSVTb.loc[i, "dt_ha2018"], corOSVTb.loc[i, "x_ha2018"] = mod.calHa2018(
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "rhov"],
                osvTb.loc[i, "lam"],
                osvTb.loc[i, "cpf"],
            ...
            corOSVTb.loc[i, "dt_dix"], corOSVTb.loc[i, "x_dix"] = mod.calDix(
                osvTb.loc[i, "kf"],
                osvTb.loc[i, "q"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "cpf"],
            ...
            corOSVTb.loc[i, "dt_sekoguchi"], corOSVTb.loc[i, "x_sekoguchi"] = mod.calSekoguchi(
                osvTb.loc[i, "q"], osvTb.loc[i, "g"], osvTb.loc[i, "cpf"], osvTb.loc[i, "lam"]
            )  # Sekoguchi (1980)
            corOSVTb.loc[i, "dt_psz"], corOSVTb.loc[i, "x_psz"] = mod.calParkSahaZuber(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "rhof"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "g"],
            ...
            corOSVTb.loc[i, "dt_kal"], corOSVTb.loc[i, "x_kal"] = mod.calKalitvianski(
                osvTb.loc[i, "q"],
                osvTb.loc[i, "dh"],
                osvTb.loc[i, "kf"],
                osvTb.loc[i, "cpf"],
    ...
    for i in range(0, len(corOSVTb)):
        if osvTb.loc[i, "alpha"] is np.nan:
            ...
            if osvTb.loc[i, "martinXeq"] < 0 and osvTb.loc[i, "xeq1"] < osvTb.loc[i, "martinXeq"]:
                corOSVTb.loc[i, "rmseMartinXeq"] = round(
                    (1 - (osvTb.loc[i, "martinXeq"] / corOSVTb.loc[i, "x_sz"])), 4
                )
                print(
                    "{}의 {} 실험 데이터의 rmseMartinXeq: {}".format(
                        osvTb.loc[i, "source"],
                        osvTb.loc[i, "run_id"],
            ...
            if (
                osvTb.loc[i, "serizawaXeq"] < 0
                and osvTb.loc[i, "xeq1"] < osvTb.loc[i, "serizawaXeq"]
            ):
                corOSVTb.loc[i, "rmseSerizawaXeq"] = round(
                    (1 - (osvTb.loc[i, "serizawaXeq"] / corOSVTb.loc[i, "x_sz"])), 4
                )
                print(
                    "{}의 {} 실험 데이터의 rmseSerizawaXeq: {}".format(
                        osvTb.loc[i, "source"],
                        osvTb.loc[i, "run_id"],
            ...
            if osvTb.loc[i, "staubXeq"] < 0 and osvTb.loc[i, "xeq1"] < osvTb.loc[i, "staubXeq"]:
                corOSVTb.loc[i, "rmseStaubXeq"] = round(
                    (1 - (osvTb.loc[i, "staubXeq"] / corOSVTb.loc[i, "x_sz"])), 4
                )
                print(
                    "{}의 {} 실험 데이터의 rmseStuabXeq: {}".format(
                        osvTb.loc[i, "source"],
                        osvTb.loc[i, "run_id"],
            ...
            # 최소값 찾기 알고리즘
            minRmse = list(
                np.abs(corOSVTb.loc[i, ["rmseSerizawaXeq", "rmseMartinXeq", "rmseStaubXeq"]])
            )
            ...
            if corOSVTb.loc[i, "tstXeq"] == 100:
                ...
                print(
                    "sol은 {}이고, rmseMartinXeq는 {}, tstXeq는 {}".format(
                        corOSVTb.loc[i, "sol"],
                        corOSVTb.loc[i, "rmseMartinXeq"],
                ...
                print(
                    "sol은 {}이고, rmseSerizawaXeq는 {}, tstXeq는 {}".format(
                        corOSVTb.loc[i, "sol"],
                        corOSVTb.loc[i, "rmseSerizawaXeq"],
                        corOSVTb.loc[i, "tstXeq"],
                    )
                ...
                print(
                    "sol은 {}이고, rmseStaubXeq는 {}, tstXeq는 {}".format(
                        corOSVTb.loc[i, "sol"],
                        corOSVTb.loc[i, "rmseStaubXeq"],
                        corOSVTb.loc[i, "tstXeq"],
                    )
    ...
    for i, rows in corOSVTb.iterrows():
        for j in model_who:
            corOSVTb.loc[i, "rmse_" + j] = round(
                (1 - corOSVTb.loc[i, "x_" + j] / corOSVTb.loc[i, "xosv"]), 4
            )
